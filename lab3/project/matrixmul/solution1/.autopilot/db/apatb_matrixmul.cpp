...
extern "C"
void matrixmul_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_matrixmul_hw(void* __xlx_apatb_param_a, void* __xlx_apatb_param_b, void* __xlx_apatb_param_res)
{
#ifdef USE_BINARY_TV_FILE
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_res),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_res),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_res),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_res),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_res),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_res),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_res };
  port2.nbytes = { 18 };
  port2.offset = {  };
  port2.hasWrite = { true };
