...
entity conv2D0_img_inT_RAM_1WNR_AUTO_1R1W is 
    generic(
...
architecture rtl of conv2D0_img_inT_RAM_1WNR_AUTO_1R1W is 
...
p_memory_access_r_8: process (clk)  
begin 
    if (clk'event and clk = '1') then
        if (ce8 = '1') then 
...
p_memory_access_w_7: process (clk)  
begin 
    if (clk'event and clk = '1') then
        if (ce0 = '1') then 
