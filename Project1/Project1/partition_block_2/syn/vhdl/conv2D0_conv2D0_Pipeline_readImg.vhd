...
attribute shreg_extract : string;
    ...
    signal tmp_reg_160 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal img_inT_addr_reg_175 : STD_LOGIC_VECTOR (2 downto 0);
    signal img_inT_1_addr_reg_180 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal select_ln22_fu_141_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal trunc_ln21_fu_116_p1 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                img_inT_1_addr_reg_180 <= zext_ln21_fu_120_p1(3 - 1 downto 0);
                img_inT_addr_reg_175 <= zext_ln21_fu_120_p1(3 - 1 downto 0);
                tmp_reg_160 <= ap_sig_allocacmp_i_2(3 downto 3);
            end if;
        end if;
    end process;
    ...
    img_inT_1_address0 <= img_inT_1_addr_reg_180;
    ...
    img_inT_1_d0 <= select_ln22_fu_141_p3;

    img_inT_1_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_reg_160, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_reg_160 = ap_const_lv1_1))) then 
    ...
    img_inT_address0 <= img_inT_addr_reg_175;
    ...
    img_inT_d0 <= select_ln22_fu_141_p3;

    img_inT_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_reg_160, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_reg_160 = ap_const_lv1_0))) then 
    ...
    img_in_0_address0 <= zext_ln21_fu_120_p1(3 - 1 downto 0);
    ...
    img_in_1_address0 <= zext_ln21_fu_120_p1(3 - 1 downto 0);
    ...
    select_ln22_fu_141_p3 <= 
        img_in_1_q0 when (tmp_reg_160(0) = '1') else 
        img_in_0_q0;
    trunc_ln21_fu_116_p1 <= ap_sig_allocacmp_i_2(3 - 1 downto 0);
    zext_ln21_fu_120_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln21_fu_116_p1),64));
end behav;
