...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("img_out_address0", 2, hls_out, 16, "ap_memory", "mem_address", 1),
	Port_Property("img_out_ce0", 1, hls_out, 16, "ap_memory", "mem_ce", 1),
	Port_Property("img_out_we0", 1, hls_out, 16, "ap_memory", "mem_we", 1),
	Port_Property("img_out_d0", 8, hls_out, 16, "ap_memory", "mem_din", 1),
	Port_Property("weights_0", 8, hls_in, 17, "ap_none", "in_data", 1),
	Port_Property("weights_1", 8, hls_in, 18, "ap_none", "in_data", 1),
	Port_Property("weights_2", 8, hls_in, 19, "ap_none", "in_data", 1),
	Port_Property("weights_3", 8, hls_in, 20, "ap_none", "in_data", 1),
	Port_Property("weights_4", 8, hls_in, 21, "ap_none", "in_data", 1),
	Port_Property("weights_5", 8, hls_in, 22, "ap_none", "in_data", 1),
	Port_Property("weights_6", 8, hls_in, 23, "ap_none", "in_data", 1),
	Port_Property("weights_7", 8, hls_in, 24, "ap_none", "in_data", 1),
	Port_Property("weights_8", 8, hls_in, 25, "ap_none", "in_data", 1),
};
