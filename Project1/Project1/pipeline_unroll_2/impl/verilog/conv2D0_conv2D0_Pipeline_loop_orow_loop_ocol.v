...
reg   [0:0] icmp_ln21_reg_953;
reg   [0:0] icmp_ln21_reg_953_pp0_iter1_reg;
reg   [0:0] icmp_ln21_reg_953_pp0_iter2_reg;
reg   [0:0] icmp_ln21_reg_953_pp0_iter3_reg;
...
wire   [1:0] sub_ln31_fu_526_p2;
reg   [1:0] sub_ln31_reg_986;
reg   [1:0] sub_ln31_reg_986_pp0_iter1_reg;
reg   [1:0] sub_ln31_reg_986_pp0_iter2_reg;
reg   [1:0] sub_ln31_reg_986_pp0_iter3_reg;
reg   [1:0] sub_ln31_reg_986_pp0_iter4_reg;
wire   [7:0] acc_fu_572_p2;
reg   [7:0] acc_reg_990;
wire   [7:0] mul_ln28_1_fu_602_p2;
reg   [7:0] mul_ln28_1_reg_995;
wire  signed [7:0] tmp_3_fu_607_p15;
wire   [7:0] mul_ln28_4_fu_657_p2;
reg   [7:0] mul_ln28_4_reg_1005;
wire   [7:0] mul_ln28_5_fu_687_p2;
reg   [7:0] mul_ln28_5_reg_1010;
wire   [7:0] grp_fu_755_p3;
reg  signed [7:0] add_ln28_reg_1015;
reg  signed [7:0] add_ln28_reg_1015_pp0_iter4_reg;
wire   [7:0] grp_fu_748_p3;
reg  signed [7:0] add_ln28_1_reg_1020;
reg  signed [7:0] add_ln28_1_reg_1020_pp0_iter4_reg;
wire   [7:0] grp_fu_741_p3;
reg  signed [7:0] add_ln28_3_reg_1025;
wire   [7:0] grp_fu_762_p3;
(* use_dsp48 = "no" *) wire   [7:0] add_ln28_6_fu_692_p2;
reg   [7:0] add_ln28_6_reg_1035;
reg   [1:0] ocol_fu_104;
wire   [1:0] add_ln27_fu_386_p2;
wire    ap_loop_init;
reg   [1:0] ap_sig_allocacmp_ocol_load;
wire    ap_block_pp0_stage0;
reg   [1:0] orow_fu_108;
wire   [1:0] select_ln21_1_fu_366_p3;
reg   [1:0] ap_sig_allocacmp_orow_load;
reg   [2:0] indvar_flatten_fu_112;
wire   [2:0] add_ln21_fu_334_p2;
...
wire   [0:0] icmp_ln22_fu_346_p2;
wire   [1:0] add_ln21_1_fu_360_p2;
wire   [0:0] trunc_ln27_fu_374_p1;
wire   [1:0] select_ln21_fu_352_p3;
wire   [7:0] tmp_1_fu_392_p13;
wire   [7:0] tmp_4_fu_424_p13;
wire   [7:0] tmp_7_fu_456_p13;
wire   [7:0] tmp_8_fu_488_p13;
wire   [1:0] shl_ln31_fu_520_p2;
...
wire  signed [7:0] add_ln28_6_fu_692_p0;
wire   [7:0] grp_fu_769_p3;
(* use_dsp48 = "no" *) wire   [7:0] add_ln28_2_fu_696_p2;
reg    ap_done_reg;
...
conv2D0_mac_muladd_8s_8s_8ns_8_4_1 #(
    ...
    .din2_WIDTH( 8 ),
    .dout_WIDTH( 8 ))
mac_muladd_8s_8s_8ns_8_4_1_U46(
    .clk(ap_clk),
    .reset(ap_rst),
...
conv2D0_mac_muladd_8s_8s_8ns_8_4_1 #(
    ...
    .din2_WIDTH( 8 ),
    .dout_WIDTH( 8 ))
mac_muladd_8s_8s_8ns_8_4_1_U47(
    .clk(ap_clk),
    .reset(ap_rst),
...
conv2D0_mac_muladd_8s_8s_8ns_8_4_1 #(
    ...
    .din2_WIDTH( 8 ),
    .dout_WIDTH( 8 ))
mac_muladd_8s_8s_8ns_8_4_1_U49(
    .clk(ap_clk),
    .reset(ap_rst),
...
conv2D0_mac_muladd_8s_8s_8ns_8_4_1 #(
    ...
    .din2_WIDTH( 8 ),
    .dout_WIDTH( 8 ))
mac_muladd_8s_8s_8ns_8_4_1_U50(
    .clk(ap_clk),
    .reset(ap_rst),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln21_fu_328_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter5 == 1'b1) & (sub_ln31_reg_986_pp0_iter4_reg == 2'd0))) begin
        img_outT_0_1_fu_116 <= img_outT_1_fu_700_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter5 == 1'b1) & (sub_ln31_reg_986_pp0_iter4_reg == 2'd1))) begin
        img_outT_1_1_fu_120 <= img_outT_1_fu_700_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter5 == 1'b1) & (sub_ln31_reg_986_pp0_iter4_reg == 2'd2))) begin
        img_outT_2_1_fu_124 <= img_outT_1_fu_700_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter5 == 1'b1) & (sub_ln31_reg_986_pp0_iter4_reg == 2'd3))) begin
        img_outT_3_1_fu_128 <= img_outT_1_fu_700_p2;
    end
end

always @ (*) begin
    if (((icmp_ln21_fu_328_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln21_reg_953_pp0_iter3_reg == 1'd1))) begin
...
assign add_ln21_1_fu_360_p2 = (ap_sig_allocacmp_orow_load + 2'd1);

assign add_ln21_fu_334_p2 = (ap_sig_allocacmp_indvar_flatten_load + 3'd1);

assign add_ln27_fu_386_p2 = (select_ln21_fu_352_p3 + 2'd1);

assign add_ln28_2_fu_696_p2 = ($signed(add_ln28_1_reg_1020_pp0_iter4_reg) + $signed(add_ln28_reg_1015_pp0_iter4_reg));

assign add_ln28_6_fu_692_p0 = grp_fu_769_p3;

assign add_ln28_6_fu_692_p2 = ($signed(add_ln28_6_fu_692_p0) + $signed(add_ln28_3_reg_1025));

assign add_ln_fu_378_p3 = {{trunc_ln27_fu_374_p1}, {select_ln21_fu_352_p3}};
...
assign icmp_ln21_fu_328_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 3'd4) ? 1'b1 : 1'b0);

assign icmp_ln22_fu_346_p2 = ((ap_sig_allocacmp_ocol_load == 2'd2) ? 1'b1 : 1'b0);

assign img_outT_0_1_out = img_outT_0_1_fu_116;

assign img_outT_1_1_out = img_outT_1_1_fu_120;

assign img_outT_1_fu_700_p2 = (add_ln28_6_reg_1035 + add_ln28_2_fu_696_p2);

assign img_outT_2_1_out = img_outT_2_1_fu_124;

assign img_outT_3_1_out = img_outT_3_1_fu_128;

assign select_ln21_1_fu_366_p3 = ((icmp_ln22_fu_346_p2[0:0] == 1'b1) ? add_ln21_1_fu_360_p2 : ap_sig_allocacmp_orow_load);

assign select_ln21_fu_352_p3 = ((icmp_ln22_fu_346_p2[0:0] == 1'b1) ? 2'd0 : ap_sig_allocacmp_ocol_load);

assign shl_ln31_fu_520_p2 = select_ln21_1_fu_366_p3 << 2'd1;

assign sub_ln31_fu_526_p2 = (select_ln21_fu_352_p3 - shl_ln31_fu_520_p2);
...
assign trunc_ln27_fu_374_p1 = select_ln21_1_fu_366_p3[0:0];
