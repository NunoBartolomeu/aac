...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("weights_0_q0", 8, hls_in, 20, "ap_memory", "mem_dout", 1),
	...
	Port_Property("weights_3_q0", 8, hls_in, 23, "ap_memory", "mem_dout", 1),
	...
	Port_Property("weights_5_we0", 1, hls_out, 25, "ap_memory", "mem_we", 1),
	Port_Property("weights_5_d0", 8, hls_out, 25, "ap_memory", "mem_din", 1),
	Port_Property("weights_5_q0", 8, hls_in, 25, "ap_memory", "mem_dout", 1),
	Port_Property("weights_5_address1", 1, hls_out, 25, "ap_memory", "MemPortADDR2", 1),
	Port_Property("weights_5_ce1", 1, hls_out, 25, "ap_memory", "MemPortCE2", 1),
	Port_Property("weights_5_we1", 1, hls_out, 25, "ap_memory", "MemPortWE2", 1),
	Port_Property("weights_5_d1", 8, hls_out, 25, "ap_memory", "MemPortDIN2", 1),
	Port_Property("weights_5_q1", 8, hls_in, 25, "ap_memory", "MemPortDOUT2", 1),
	...
	Port_Property("weights_6_we0", 1, hls_out, 26, "ap_memory", "mem_we", 1),
	Port_Property("weights_6_d0", 8, hls_out, 26, "ap_memory", "mem_din", 1),
	Port_Property("weights_6_q0", 8, hls_in, 26, "ap_memory", "mem_dout", 1),
	Port_Property("weights_6_address1", 1, hls_out, 26, "ap_memory", "MemPortADDR2", 1),
	Port_Property("weights_6_ce1", 1, hls_out, 26, "ap_memory", "MemPortCE2", 1),
	Port_Property("weights_6_we1", 1, hls_out, 26, "ap_memory", "MemPortWE2", 1),
	Port_Property("weights_6_d1", 8, hls_out, 26, "ap_memory", "MemPortDIN2", 1),
	Port_Property("weights_6_q1", 8, hls_in, 26, "ap_memory", "MemPortDOUT2", 1),
	...
	Port_Property("weights_7_we0", 1, hls_out, 27, "ap_memory", "mem_we", 1),
	Port_Property("weights_7_d0", 8, hls_out, 27, "ap_memory", "mem_din", 1),
	Port_Property("weights_7_q0", 8, hls_in, 27, "ap_memory", "mem_dout", 1),
	Port_Property("weights_7_address1", 1, hls_out, 27, "ap_memory", "MemPortADDR2", 1),
	Port_Property("weights_7_ce1", 1, hls_out, 27, "ap_memory", "MemPortCE2", 1),
	Port_Property("weights_7_we1", 1, hls_out, 27, "ap_memory", "MemPortWE2", 1),
	Port_Property("weights_7_d1", 8, hls_out, 27, "ap_memory", "MemPortDIN2", 1),
	Port_Property("weights_7_q1", 8, hls_in, 27, "ap_memory", "MemPortDOUT2", 1),
};
