; ModuleID = 'D:/Cadeiras/AAC/labs/Project1/Project1/partition_block_best_values/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_0, i32 999, i32 1, i32 1, i1 false) ], !dbg !49
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_1, i32 999, i32 1, i32 1, i1 false) ], !dbg !49
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_2, i32 999, i32 1, i32 1, i1 false) ], !dbg !49
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_3, i32 999, i32 1, i32 1, i1 false) ], !dbg !49
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_4, i32 999, i32 1, i32 1, i1 false) ], !dbg !49
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_5, i32 999, i32 1, i32 1, i1 false) ], !dbg !49
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_6, i32 999, i32 1, i32 1, i1 false) ], !dbg !49
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_7, i32 999, i32 1, i32 1, i1 false) ], !dbg !49
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_0, i32 998, i32 1, i32 0, i1 false) ], !dbg !49
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_1, i32 998, i32 1, i32 0, i1 false) ], !dbg !49
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_2, i32 998, i32 1, i32 0, i1 false) ], !dbg !49
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_3, i32 998, i32 1, i32 0, i1 false) ], !dbg !49
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_4, i32 998, i32 1, i32 0, i1 false) ], !dbg !49
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_5, i32 998, i32 1, i32 0, i1 false) ], !dbg !49
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_6, i32 998, i32 1, i32 0, i1 false) ], !dbg !49
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i8* %_7, i32 998, i32 1, i32 0, i1 false) ], !dbg !49
...
for.loop:                                         ; preds = %dst.addr.exit, %for.loop.lr.ph
  %for.loop.idx2 = phi i64 [ 0, %for.loop.lr.ph ], [ %for.loop.idx.next, %dst.addr.exit ]
  %3 = urem i64 %for.loop.idx2, 2
  %4 = udiv i64 %for.loop.idx2, 2
  %5 = trunc i64 %4 to i3
...
dst.addr.case.2:                                  ; preds = %for.loop
  store i8 %6, i8* %dst.addr_2, align 1
  br label %dst.addr.exit

dst.addr.case.3:                                  ; preds = %for.loop
  store i8 %6, i8* %dst.addr_3, align 1
  br label %dst.addr.exit

dst.addr.case.4:                                  ; preds = %for.loop
  store i8 %6, i8* %dst.addr_4, align 1
  br label %dst.addr.exit

dst.addr.case.5:                                  ; preds = %for.loop
  store i8 %6, i8* %dst.addr_5, align 1
  br label %dst.addr.exit

dst.addr.case.6:                                  ; preds = %for.loop
  store i8 %6, i8* %dst.addr_6, align 1
  br label %dst.addr.exit

dst.addr.case.7:                                  ; preds = %for.loop
  store i8 %6, i8* %dst.addr_7, align 1
  br label %dst.addr.exit
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_in([16 x i8]* noalias readonly "orig.arg.no"="0", i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.0" %_0, i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.1" %_1, i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.2" %_2, i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.3" %_3, i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.4" %_4, i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.5" %_5, i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.6" %_6, i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.7" %_7, i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.8" %_8, i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.9" %_9, i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.10" %_10, i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.11" %_11, i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.12" %_12, i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.13" %_13, i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.14" %_14, i8* noalias align 512 "orig.arg.no"="1" "unpacked"="1.15" %_15, [4 x i8]* noalias readonly "orig.arg.no"="2", i8* noalias align 512 "orig.arg.no"="3" "unpacked"="3.0" %_01, i8* noalias align 512 "orig.arg.no"="3" "unpacked"="3.1" %_16, i8* noalias align 512 "orig.arg.no"="3" "unpacked"="3.2" %_27, i8* noalias align 512 "orig.arg.no"="3" "unpacked"="3.3" %_38, [9 x i8]* noalias readonly "orig.arg.no"="4", [2 x i8]* noalias align 512 "orig.arg.no"="5" "unpacked"="5.0" %_09, [2 x i8]* noalias align 512 "orig.arg.no"="5" "unpacked"="5.1" %_110, [2 x i8]* noalias align 512 "orig.arg.no"="5" "unpacked"="5.2" %_211, [2 x i8]* noalias align 512 "orig.arg.no"="5" "unpacked"="5.3" %_312, [2 x i8]* noalias align 512 "orig.arg.no"="5" "unpacked"="5.4" %_413, [2 x i8]* noalias align 512 "orig.arg.no"="5" "unpacked"="5.5" %_514, [2 x i8]* noalias align 512 "orig.arg.no"="5" "unpacked"="5.6" %_615, [2 x i8]* noalias align 512 "orig.arg.no"="5" "unpacked"="5.7" %_716) #4 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a9i8.27.30([9 x i8]* noalias "orig.arg.no"="0" %dst, [2 x i8]* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src_0, [2 x i8]* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.1" %src_1, [2 x i8]* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.2" %src_2, [2 x i8]* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.3" %src_3, [2 x i8]* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.4" %src_4, [2 x i8]* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.5" %src_5, [2 x i8]* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.6" %src_6, [2 x i8]* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.7" %src_7) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_out([16 x i8]* noalias "orig.arg.no"="0", i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %_0, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.1" %_1, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.2" %_2, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.3" %_3, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.4" %_4, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.5" %_5, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.6" %_6, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.7" %_7, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.8" %_8, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.9" %_9, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.10" %_10, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.11" %_11, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.12" %_12, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.13" %_13, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.14" %_14, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.15" %_15, [4 x i8]* noalias "orig.arg.no"="2", i8* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.0" %_01, i8* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.1" %_16, i8* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.2" %_27, i8* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.3" %_38, [9 x i8]* noalias "orig.arg.no"="4", [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.0" %_09, [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.1" %_110, [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.2" %_211, [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.3" %_312, [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.4" %_413, [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.5" %_514, [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.6" %_615, [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.7" %_716) #5 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_back([16 x i8]* noalias "orig.arg.no"="0", i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %_0, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.1" %_1, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.2" %_2, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.3" %_3, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.4" %_4, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.5" %_5, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.6" %_6, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.7" %_7, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.8" %_8, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.9" %_9, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.10" %_10, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.11" %_11, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.12" %_12, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.13" %_13, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.14" %_14, i8* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.15" %_15, [4 x i8]* noalias "orig.arg.no"="2", i8* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.0" %_01, i8* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.1" %_16, i8* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.2" %_27, i8* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.3" %_38, [9 x i8]* noalias "orig.arg.no"="4", [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.0" %_09, [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.1" %_110, [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.2" %_211, [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.3" %_312, [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.4" %_413, [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.5" %_514, [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.6" %_615, [2 x i8]* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.7" %_716) #5 {
entry:
  call void @onebyonecpy_hls.p0a4i8.23.26([4 x i8]* %1, i8* align 512 %_01, i8* align 512 %_16, i8* align 512 %_27, i8* align 512 %_38)
  ret void
}

define void @conv2D0_hw_stub_wrapper(i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, [2 x i8]*, [2 x i8]*, [2 x i8]*, [2 x i8]*, [2 x i8]*, [2 x i8]*, [2 x i8]*, [2 x i8]*) #6 {
entry:
  %28 = alloca [16 x i8]
  %29 = alloca [4 x i8]
  %30 = alloca [9 x i8]
...
!37 = !{!"2", [9 x i8]* null}
!38 = !{!39}
!39 = !{!"array_partition", !"type=Block", !"dim=1", !"factor=8"}
...
!50 = distinct !DISubprogram(name: "conv2D0", linkageName: "_Z7conv2D0PhPaS0_", scope: !51, file: !51, line: 7, type: !52, isLocal: false, isDefinition: true, scopeLine: 7, flags: DIFlagPrototyped, isOptimized: false, unit: !58, variables: !4)
...
!59 = !DIFile(filename: "D:/Cadeiras/AAC/labs/Project1/Project1/partition_block_best_values/.autopilot/db\5Cconv2D0.pp.0.cpp", directory: "D:\5CCadeiras\5CAAC\5Clabs\5CProject1")
