...
set C_modelArgList {
	...
	{ img_outT_reload int 8 regular  }
	{ img_outT_1_reload int 8 regular  }
	{ img_outT_2_reload int 8 regular  }
	{ img_outT_3_reload int 8 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "img_out_0", "interface" : "wire", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "img_outT_reload", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "img_outT_1_reload", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "img_outT_2_reload", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "img_outT_3_reload", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ img_out_0 sc_out sc_lv 8 signal 0 } 
	{ img_out_0_ap_vld sc_out sc_logic 1 outvld 0 } 
	{ img_out_3 sc_out sc_lv 8 signal 1 } 
	{ img_out_3_ap_vld sc_out sc_logic 1 outvld 1 } 
	{ img_out_2 sc_out sc_lv 8 signal 2 } 
	{ img_out_2_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ img_out_1 sc_out sc_lv 8 signal 3 } 
	{ img_out_1_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ img_outT_reload sc_in sc_lv 8 signal 4 } 
	{ img_outT_1_reload sc_in sc_lv 8 signal 5 } 
	{ img_outT_2_reload sc_in sc_lv 8 signal 6 } 
	{ img_outT_3_reload sc_in sc_lv 8 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "img_outT_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "img_outT_reload", "role": "default" }} , 
 	{ "name": "img_outT_1_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "img_outT_1_reload", "role": "default" }} , 
 	{ "name": "img_outT_2_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "img_outT_2_reload", "role": "default" }} , 
 	{ "name": "img_outT_3_reload", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "img_outT_3_reload", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_2_8_1_1_U106", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	img_outT_reload { ap_none {  { img_outT_reload in_data 0 8 } } }
	img_outT_1_reload { ap_none {  { img_outT_1_reload in_data 0 8 } } }
	img_outT_2_reload { ap_none {  { img_outT_2_reload in_data 0 8 } } }
	img_outT_3_reload { ap_none {  { img_outT_3_reload in_data 0 8 } } }
}
