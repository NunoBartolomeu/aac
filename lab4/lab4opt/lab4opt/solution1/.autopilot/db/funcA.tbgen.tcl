...
set C_modelArgList {
	...
	{ out1 int 32 regular {array 10 { 0 3 } 0 1 }  }
	{ out2 int 30 regular {array 10 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "vecIn", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "out2", "interface" : "memory", "bitwidth" : 30, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ out1_address0 sc_out sc_lv 4 signal 1 } 
	...
	{ out2_d0 sc_out sc_lv 30 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out1_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "out1", "role": "address0" }} , 
 	...
 	{ "name": "out2_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "out2", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	out1 { ap_memory {  { out1_address0 mem_address 1 4 }  { out1_ce0 mem_ce 1 1 }  { out1_we0 mem_we 1 1 }  { out1_d0 mem_din 1 32 } } }
	out2 { ap_memory {  { out2_address0 mem_address 1 4 }  { out2_ce0 mem_ce 1 1 }  { out2_we0 mem_we 1 1 }  { out2_d0 mem_din 1 30 } } }
}
