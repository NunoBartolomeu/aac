...
$(ObjDir)/functionDF_tb.cpp_pre.cpp.tb.o : functionDF_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling functionDF_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/functionDF.cpp_pre.cpp.tb.o : functionDF.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling functionDF.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
