...
# 
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/Cadeiras/AAC/xilinx/Vitis_HLS/2023.2/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);D:/Cadeiras/AAC/xilinx/Vitis_HLS/2023.2/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/Cadeiras/AAC/xilinx/Vitis_HLS/2023.2/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Cadeiras/AAC/xilinx/Vitis_HLS/2023.2/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "functionDF.autotvin.dat"
	set constFileTvOut       "functionDF.autotvout.dat"
	set constFileHdlTvIn     "functionDF.autohdltvin.dat"
	set constFileHdlTvOut    "functionDF.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
