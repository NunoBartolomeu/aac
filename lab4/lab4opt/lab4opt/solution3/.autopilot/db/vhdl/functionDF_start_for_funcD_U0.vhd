...
entity functionDF_start_for_funcD_U0 is 
    generic (
...
architecture rtl of functionDF_start_for_funcD_U0 is

    component functionDF_start_for_funcD_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_functionDF_start_for_funcD_U0_ShiftReg : functionDF_start_for_funcD_U0_ShiftReg
    generic map (
...
entity functionDF_start_for_funcD_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end functionDF_start_for_funcD_U0_ShiftReg;

architecture rtl of functionDF_start_for_funcD_U0_ShiftReg is
