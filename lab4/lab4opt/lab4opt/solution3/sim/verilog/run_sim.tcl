...
if {[file isfile functionDF.autotvin.dat]} {
	file delete -force functionDF.autotvin.dat
}

if {[file isfile functionDF.autotvout.dat]} {
	file delete -force functionDF.autotvout.dat
}
