...
reg   [31:0] c1_read_reg_97;
reg   [3:0] i_fu_38;
wire   [3:0] add_ln17_fu_69_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_115)) begin
        if ((icmp_ln17_fu_63_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln17_fu_63_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln17_fu_69_p2 = (ap_sig_allocacmp_i_3 + 4'd1);
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (c1_empty_n == 1'b0);
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = (c3_full_n == 1'b0);
end
...
assign c3_din = (c1_read_reg_97 + 32'd25);

assign icmp_ln17_fu_63_p2 = ((ap_sig_allocacmp_i_3 == 4'd10) ? 1'b1 : 1'b0);
