...
architecture behav of functionDF is 
    ...
    "functionDF_functionDF,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010i-clg225-1L,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.196000,HLS_SYN_LAT=38,HLS_SYN_TPT=13,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=171,HLS_SYN_LUT=461,HLS_VERSION=2023_2}";
    ...
    signal c1_i_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal c1_t_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal c2_i_q0 : STD_LOGIC_VECTOR (29 downto 0);
    signal c2_t_q0 : STD_LOGIC_VECTOR (29 downto 0);
    signal c3_i_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal c3_t_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal c4_i_q0 : STD_LOGIC_VECTOR (30 downto 0);
    signal c4_t_q0 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal funcA_U0_out1_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal funcA_U0_out1_ce0 : STD_LOGIC;
    signal funcA_U0_out1_we0 : STD_LOGIC;
    signal funcA_U0_out1_d0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal funcA_U0_out2_d0 : STD_LOGIC_VECTOR (29 downto 0);
    ...
    signal funcB_U0_in_r_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal funcB_U0_in_r_ce0 : STD_LOGIC;
    signal funcB_U0_out_r_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal funcB_U0_out_r_ce0 : STD_LOGIC;
    signal funcB_U0_out_r_we0 : STD_LOGIC;
    signal funcB_U0_out_r_d0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal funcC_U0_out_r_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal funcC_U0_out_r_ce0 : STD_LOGIC;
    signal funcC_U0_out_r_we0 : STD_LOGIC;
    signal funcC_U0_out_r_d0 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal funcD_U0_in1_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal funcD_U0_in1_ce0 : STD_LOGIC;
    signal funcD_U0_in2_address0 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    port (
        ...
        vecIn_ce0 : OUT STD_LOGIC;
        vecIn_q0 : IN STD_LOGIC_VECTOR (31 downto 0);
        out1_address0 : OUT STD_LOGIC_VECTOR (3 downto 0);
        ...
        out2_d0 : OUT STD_LOGIC_VECTOR (29 downto 0) );
    end component;
    ...
    port (
        ...
        in_r_address0 : OUT STD_LOGIC_VECTOR (3 downto 0);
        in_r_ce0 : OUT STD_LOGIC;
        in_r_q0 : IN STD_LOGIC_VECTOR (29 downto 0);
        out_r_address0 : OUT STD_LOGIC_VECTOR (3 downto 0);
        out_r_ce0 : OUT STD_LOGIC;
        out_r_we0 : OUT STD_LOGIC;
        out_r_d0 : OUT STD_LOGIC_VECTOR (30 downto 0) );
    end component;
    ...
    port (
        ...
        in2_q0 : IN STD_LOGIC_VECTOR (30 downto 0);
        vecOut_address0 : OUT STD_LOGIC_VECTOR (3 downto 0);
        vecOut_ce0 : OUT STD_LOGIC;
        vecOut_we0 : OUT STD_LOGIC;
        vecOut_d0 : OUT STD_LOGIC_VECTOR (31 downto 0) );
    ...
    component functionDF_c1_RAM_AUTO_1R1W IS
    generic (
        DataWidth : INTEGER;
    ...
    port (
        ...
        i_ce0 : IN STD_LOGIC;
        i_we0 : IN STD_LOGIC;
        i_d0 : IN STD_LOGIC_VECTOR (29 downto 0);
        i_q0 : OUT STD_LOGIC_VECTOR (29 downto 0);
        t_address0 : IN STD_LOGIC_VECTOR (3 downto 0);
        t_ce0 : IN STD_LOGIC;
        t_we0 : IN STD_LOGIC;
        t_d0 : IN STD_LOGIC_VECTOR (29 downto 0);
        t_q0 : OUT STD_LOGIC_VECTOR (29 downto 0);
        i_ce : IN STD_LOGIC;
        t_ce : IN STD_LOGIC;
        i_full_n : OUT STD_LOGIC;
        i_write : IN STD_LOGIC;
    ...
    component functionDF_c4_RAM_AUTO_1R1W IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
...
begin
    c1_U : component functionDF_c1_RAM_AUTO_1R1W
    generic map (
        DataWidth => 32,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    c3_U : component functionDF_c1_RAM_AUTO_1R1W
    generic map (
        DataWidth => 32,
        AddressRange => 10,
        AddressWidth => 4)
    ...
    c4_U : component functionDF_c4_RAM_AUTO_1R1W
    generic map (
        DataWidth => 31,
        AddressRange => 10,
        AddressWidth => 4)
