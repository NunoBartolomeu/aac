...
set C_modelArgList {
	{ in_r int 32 regular {array 10 { 1 3 } 1 1 }  }
	{ out_r int 32 regular {array 10 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set Spec2ImplPortList { 
	in_r { ap_memory {  { in_r_address0 mem_address 1 4 }  { in_r_ce0 mem_ce 1 1 }  { in_r_q0 in_data 0 32 } } }
